...
#mad
SRC_C += ../src/mad/mad_version.c
SRC_C += ../src/mad/mpg12/layer12.c
SRC_C += ../src/mad/frame.c
SRC_C += ../src/mad/layer3.c
SRC_C += ../src/mad/align.c
SRC_C += ../src/mad/decoder.c
SRC_C += ../src/mad/huffman.c
SRC_C += ../src/mad/fixed.c
SRC_C += ../src/mad/bit.c
SRC_C += ../src/mad/synth.c
SRC_C += ../src/mad/timer.c
SRC_C += ../src/mad/stream.c
...
CFLAGS =
CFLAGS += -DM3 -DCONFIG_PLATFORM_8195A -DGCC_ARMCM3 -DARDUINO_SDK -DICACHE_FLASH
