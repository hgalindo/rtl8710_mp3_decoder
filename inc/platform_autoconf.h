...
//sk//#undef  CONFIG_DEBUG_WARN_MSG
#define CONFIG_DEBUG_WARN_MSG
//sk//#undef  CONFIG_DEBUG_INFO_MSG
#define CONFIG_DEBUG_INFO_MSG

/*
 * < SDK Option Config 
 */
//sk//#undef  CONFIG_MBED_ENABLED
#define CONFIG_MBED_ENABLED
